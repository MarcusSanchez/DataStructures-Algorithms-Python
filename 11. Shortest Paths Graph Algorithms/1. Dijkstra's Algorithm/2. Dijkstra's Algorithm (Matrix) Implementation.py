...
class DijkstraAlgorithm:
    ...
    def __init__(self, adjacency_matrix, start_vertex):
        ...
        self.visited = [False for _ in adjacency_matrix]
        self.distances = [float('inf') for _ in adjacency_matrix]
        self.distances[start_vertex] = 0

    def get_min_vertex(self):

        # will find the vertex with the lowest index value
    ...
    def calculate(self):
        ...
        for vertex in range(self.v):
            ...
            # it has again O(V) running itme - so the overall running time is quadratic
