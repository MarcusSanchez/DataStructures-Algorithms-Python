# Interview question #16 - detecting negative cycles on the FOREX
#
# We can find the shortest path in a given G(V,E) graph with Dijkstra's algorithm, and we can handle even negative edge
# weights with Bellman-Ford approach. Let's use Bellman-Ford approach to find negative cycles on the FOREX!
# Check out the next video, and you will learn about the theory behind arbitrage opportunities.
